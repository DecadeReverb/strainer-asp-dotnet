...
{
    public class NotEqualsCaseInsensitiveOperatorTests : StrainerFixtureBase
    {
        public NotEqualsCaseInsensitiveOperatorTests(StrainerFactory factory) : base(factory)
        {
